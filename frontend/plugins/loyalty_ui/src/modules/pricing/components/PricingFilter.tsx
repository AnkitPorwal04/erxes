    ...
    <>
      ...
      {isQuantityEnabled === true && (
        <Filter.BarItem queryKey="isQuantityEnabled">
          ...
          <Filter.BarButton filterKey="isQuantityEnabled">{t('yes', 'Yes')}</Filter.BarButton>
        </Filter.BarItem>
      )}
      ...
      {isPriceEnabled === true && (
        <Filter.BarItem queryKey="isPriceEnabled">
          ...
          <Filter.BarButton filterKey="isPriceEnabled">{t('yes', 'Yes')}</Filter.BarButton>
        </Filter.BarItem>
      )}
      ...
      {isExpiryEnabled === true && (
        <Filter.BarItem queryKey="isExpiryEnabled">
          ...
          <Filter.BarButton filterKey="isExpiryEnabled">{t('yes', 'Yes')}</Filter.BarButton>
        </Filter.BarItem>
      )}
      ...
      {isRepeatEnabled === true && (
        <Filter.BarItem queryKey="isRepeatEnabled">
          ...
          <Filter.BarButton filterKey="isRepeatEnabled">{t('yes', 'Yes')}</Filter.BarButton>
        </Filter.BarItem>
      )}
    </>
  );
        ...
        <Command>
          ...
          <Command.List className="p-1">
            ...
            <Filter.Item value="isPriority">
              <IconFilter size={16} />
              {t('prioritize-rule', 'Prioritize Rule')}
            </Filter.Item>
